...
import { Minus, Plus, Trash2, Trash2Icon } from "lucide-react";
        ...
        <div class="rounded-lg lg:w-[70%] w-full">
          <div class="justify-between mb-6 rounded-lg bg-white p-2 shadow-md sm:flex sm:justify-start">
            <Table>
              ...
              <TableHeader>
                <TableRow>
                  <TableHead className="w-[450px] text-base font-semibold">
                    Product
                  </TableHead>
                ...
                {Object.keys(cart).map((key) => {
                  return (
                    <TableRow key={key} className="relative">
                      ...
                      <TableCell className="text-center">
                        Rs. {cart[key]?.quantity * cart[key]?.price}
                      </TableCell>
                        ...
                        <div
                          ...
                          onClick={() => {
                            clearCartById({
                              id: cart[key]?.id,
                              color: cart[key]?.color,
                              quantity: cart[key]?.quantity, // Remove all quantities
                              size: cart[key]?.size,
                              image: cart[key]?.image,
                              price: cart[key]?.price,
                            });
        ...
        <div class=" h-full rounded-lg bg-white px-6 py-7 shadow-md lg:mt-0 lg:w-[35%] w-full">
          ...
          <div class="flex justify-between">
            ...
            <div className="space-y-1 text-right text-sm">
              <p class="text-gray-700"> Shipping Charges: Rs 0</p>
