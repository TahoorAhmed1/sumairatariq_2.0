            ...
            {data.map((color, index) => (
              ...
              >
                <input
                  ...
                  checked={selectedColors?.includes(color)} // Check if this color should be checked
                  onChange={() => toggleColorSelection(color)} // Toggle selection when checkbox is clicked
                />
                <span
