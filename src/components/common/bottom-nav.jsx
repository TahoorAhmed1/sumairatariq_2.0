...
function BottomNav({ token }) {
  ...
  return (
    <div className="md:pt-0 pt-12">
      <div className="fixed bottom-0 left-0 right-0 py-4  container lg:hidden bg-white shadow-[50px] z-40 w-full flex items-center justify-between box-shadow-footer">
        <Link
          href={"/"}
